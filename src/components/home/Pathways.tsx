  ...
  return (
    <section className="flex flex-col lg:flex-row min-h-[72vh]">
      ...
      <motion.div
        ...
        className="relative flex-1 bg-navy-950 px-8 lg:px-16 py-20 lg:py-28 flex flex-col justify-between overflow-hidden"
      >
        <span
          className="absolute top-6 right-8 text-[9rem] font-bold leading-none text-white/[0.03] select-none pointer-events-none"
          aria-hidden="true"
        >
          01
        </span>
        ...
        <div className="mt-14">
          <Link
            href="/parents"
            className="inline-flex items-center gap-3 text-[13px] font-semibold text-white border border-white/15 px-6 py-3 rounded-full hover:bg-white hover:text-navy-950 transition-all duration-250"
          >
