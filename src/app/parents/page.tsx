...
const getConditions = (lang: Lang) => [
  {
    ...
    icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="10" width="16" height="10" rx="1.5" /><circle cx="9" cy="7" r="2.2" /><circle cx="15" cy="7" r="2.2" /></svg>),
  },
  {
    color: GREEN,
